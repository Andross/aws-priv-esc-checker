module github.com/aws-priv-esc-checker

go 1.18

replace github.com/Andross/aws-priv-esc-checker/aws-pe-checker-lib => ./libs

require (
	github.com/Andross/aws-priv-esc-checker/aws-pe-checker-lib v0.0.0-00010101000000-000000000000
